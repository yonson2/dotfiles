...
-- display invisible chars like line breaks and tabs
vim.opt.listchars:append({ eol = '↵', tab = '▷▷⋮', extends = '>', precedes = '<', nbsp = '+' })
...
-- " copilot
-- vim.keymap.set({ 'n' }, 'tt', '<Plug>(copilot-suggest)', { desc = 'Trigger copilot suggestion' })
-- vim.keymap.set({ 'n' }, 'tn', '<Plug>(copilot-next)', { desc = 'Trigger copilot next suggestion' })
-- vim.keymap.set({ 'n' }, 'tp', '<Plug>(copilot-previous)', { desc = 'Trigger copilot previous suggestion' })
