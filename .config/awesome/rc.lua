...
user = {
    ...
    dirs = {
        ...
        git = os.getenv("XDG_GIT_DIR") or "~/git",
        projects = os.getenv("XDG_projects_DIR") or "~/projects",
    ...
    lock_screen_custom_password = "jalisco",
    ...
    openweathermap_key = "3e5382f4f0c0235a6bce6f4a99e96e3b",
    openweathermap_city_id = "3117735",
...
-- (leave one pixel so the sidebar still shows)
awful.screen.focused().tags[2].gap = 1
...
-- stolen from https://stackoverflow.com/a/44120615
...
client.connect_signal("property::floating", function(c) setTitlebar(c, c.floating) end)
